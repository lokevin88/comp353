<div class="row mt-3">
        ...
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    <button class="btn btn-outline-secondary" name="submitGroupReplyPost-<?php echo $row['gPostsID']; ?>"
    ...
    <div id="replyBlock-<?php echo $row['gPostsID']; ?>" style="display:none; width:100%">
        <?php
            foreach($group_all_replies_on_member_posting as $row):
        ?>
